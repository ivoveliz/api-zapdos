...
class IoTHubTokenCredentials {
    ...
    signRequest(webResource) {
        const sas = azure_iot_common_1.SharedAccessSignature.create(this._connectionString.HostName, this._connectionString.SharedAccessKeyName, this._connectionString.SharedAccessKey, (0, azure_iot_common_1.anHourFromNow)()).toString();
