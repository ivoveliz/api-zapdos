...
class Query {
     ...
     */
    constructor(executeQueryFn, registry) {
        if (!executeQueryFn)
    ...
    next(continuationTokenOrCallback, done) {
    ...
    nextAsTwin(continuationToken, done) {
        ...
        return (0, azure_iot_common_1.tripleValueCallbackToPromise)((_callback) => {
            const ct = continuationToken || this.continuationToken;
                ...
                if (err) {
                    ...
                    if (result) {
                        ...
                        const twins = result.map((twinJson) => {
                            return new twin_1.Twin(twinJson, this._registry);
                        });
