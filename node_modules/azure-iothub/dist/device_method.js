 ...
 */
class DeviceMethod {
    constructor(params, restApiClient) {
        if (!params)
    ...
    invokeOn(deviceId, done) {
        return (0, azure_iot_common_1.tripleValueCallbackToPromise)((_callback) => {
            ...
            const path = '/twins/' + encodeURIComponent(deviceId) + '/methods' + (0, version_1.versionQueryString)();
            const headers = {
    ...
    invokeOnModule(deviceId, moduleId, done) {
        return (0, azure_iot_common_1.tripleValueCallbackToPromise)((_callback) => {
            ...
            const path = '/twins/' + encodeURIComponent(deviceId) + '/modules/' + encodeURIComponent(moduleId) + '/methods' + (0, version_1.versionQueryString)();
            const headers = {
                'Content-Type': 'application/json; charset=utf-8'
            };
