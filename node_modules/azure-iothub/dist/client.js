...
const azure_iot_common_3 = require("azure-iot-common");
...
class Client extends events_1.EventEmitter {
    ...
    open(done) {
        return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
            ...
            const retryOp = new azure_iot_common_2.RetryOperation('open', this._retryPolicy, MAX_RETRY_TIMEOUT);
    ...
    send(deviceId, message, done) {
        return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
            ...
            const retryOp = new azure_iot_common_2.RetryOperation('send', this._retryPolicy, MAX_RETRY_TIMEOUT);
            retryOp.retry((retryCallback) => {
    ...
    _invokeDeviceMethod(deviceId, moduleIdOrMethodParams, methodParamsOrDone, done) {
        ...
        const retryOp = new azure_iot_common_2.RetryOperation('invokeOnModule', this._retryPolicy, MAX_RETRY_TIMEOUT);
        retryOp.retry((retryCallback) => {
    ...
    getFeedbackReceiver(done) {
        return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
            ...
            const retryOp = new azure_iot_common_2.RetryOperation('getFeedbackReceiver', this._retryPolicy, MAX_RETRY_TIMEOUT);
            retryOp.retry((retryCallback) => {
    ...
    getFileNotificationReceiver(done) {
        return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
            ...
            const retryOp = new azure_iot_common_2.RetryOperation('getFileNotificationReceiver', this._retryPolicy, MAX_RETRY_TIMEOUT);
            retryOp.retry((retryCallback) => {
    ...
    _disconnectHandler(reason) {
        ...
        const evt = new azure_iot_common_1.results.Disconnected();
        evt.reason = reason;
    ...
    static fromConnectionString(connStr, transportCtor) {
        ...
        const config = {
            ...
            sharedAccessSignature: azure_iot_common_1.SharedAccessSignature.create(cn.HostName, cn.SharedAccessKeyName, cn.SharedAccessKey, (0, azure_iot_common_1.anHourFromNow)()),
    ...
    static fromSharedAccessSignature(sharedAccessSignature, transportCtor) {
        ...
        const sas = azure_iot_common_1.SharedAccessSignature.parse(sharedAccessSignature);
