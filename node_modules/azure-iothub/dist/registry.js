...
const azure_iot_http_base_1 = require("azure-iot-http-base");
...
class Registry {
    ...
    constructor(config, restApiClient) {
        if (!config) {
            ...
            throw new azure_iot_common_1.errors.ArgumentError('The \'config\' argument is missing either the host property');
        }
        else if ((!config.sharedAccessSignature) && (!config.tokenCredential)) {
            throw new azure_iot_common_1.errors.ArgumentError('The \'config\' argument is missing either the sharedAccessSignature or the tokenCredential property');
        }
        else if ((config.sharedAccessSignature) && (config.tokenCredential)) {
            throw new azure_iot_common_1.errors.ArgumentError('The \'config\' argument has both the sharedAccessSignature and the tokenCredential property defined');
        }
    ...
    create(deviceInfo, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            if (!deviceInfo) {
                ...
                throw new azure_iot_common_1.errors.ArgumentError('The object \'deviceInfo\' is missing the property: deviceId');
            }
            ...
            <deviceInfo>
            ```]*/
            const path = azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceInfo.deviceId)) + (0, version_1.versionQueryString)();
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    get(deviceId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            Request-Id: <guid>
            ```]*/
            const path = azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId)) + (0, version_1.versionQueryString)();
    ...
    list(done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            /*Codes_SRS_NODE_IOTHUB_REGISTRY_16_029: [The `list` method shall construct an HTTP request using information supplied by the caller, as follows:
               ...
               Request-Id: <guid>
               ```]*/
            const path = azure_iot_common_1.endpoint.devicePath('') + (0, version_1.versionQueryString)();
    ...
    importDevicesFromBlob(inputBlobContainerUri, outputBlobContainerUri, done) {
        return (0, azure_iot_common_2.callbackToPromise)((_callback) => {
    ...
    addConfiguration(configuration, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            if (!configuration.id)
                throw new azure_iot_common_1.errors.ArgumentError('configuration object is missing id property');
    ...
    _updateConfiguration(configuration, forceUpdateOrDone, done) {
        ...
        if (!forceUpdate && !configuration.etag) {
            throw new azure_iot_common_1.errors.ArgumentError('The ETag should be set while updating the Configuration.');
        }
    ...
    updateConfiguration(configuration, forceUpdateOrDone, done) {
        ...
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => this._updateConfiguration(configuration, forceUpdateOrDone, _callback));
    }
    ...
    applyConfigurationContentOnDevice(deviceId, content, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId))}/applyConfigurationContent${(0, version_1.versionQueryString)()}`;
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    addModule(module, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            if (!module.deviceId)
                throw new azure_iot_common_1.errors.ArgumentError('deviceId property is missing from module object');
            if (!module.moduleId)
                throw new azure_iot_common_1.errors.ArgumentError('moduleId property is missing from module object');
            ...
            const path = `${azure_iot_common_1.endpoint.modulePath(encodeURIComponent(preparedModule.deviceId), encodeURIComponent(preparedModule.moduleId))}${(0, version_1.versionQueryString)()}`;
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    getModulesOnDevice(deviceId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId))}/modules${(0, version_1.versionQueryString)()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    getModule(deviceId, moduleId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.modulePath(encodeURIComponent(deviceId), encodeURIComponent(moduleId))}${(0, version_1.versionQueryString)()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    _updateModule(module, forceUpdateOrDone, done) {
        ...
        if (!forceUpdate && !module.etag) {
            throw new azure_iot_common_1.errors.ArgumentError('The ETag should be set while updating the Module.');
        }
        const preparedModule = JSON.parse(JSON.stringify(module));
        this._normalizeAuthentication(preparedModule);
    ...
    _removeModule(moduleOrDeviceId, doneOrModuleId, done) {
        ...
        if (typeof deviceId !== 'string')
            throw new azure_iot_common_1.errors.ArgumentError('\'deviceId\' must be a string');
        if (typeof moduleId !== 'string')
            throw new azure_iot_common_1.errors.ArgumentError('\'moduleId\' must be a string');
        if (typeof (done) !== 'function')
            throw new azure_iot_common_1.errors.ArgumentError('\'done\' must be a function');
    ...
    _processBulkDevices(devices, operation, force, forceTrueAlternative, forceFalseAlternative, done) {
        if (!devices) {
            ...
            throw new azure_iot_common_1.errors.ArgumentError('devices must be an array');
        }
            ...
            throw new azure_iot_common_1.errors.ArgumentError('The device array has an invalid size of ' + devices.length);
        }
        else {
            let importMode;
            if (operation === null) {
            ...
            devices.forEach((currentDevice) => {
                if (!currentDevice.deviceId) {
                    ...
                    throw new azure_iot_common_1.errors.ArgumentError('The object is missing the property: deviceId');
                }
                else {
                    //
    ...
    static fromSharedAccessSignature(value) {
        ...
        const sas = azure_iot_common_1.SharedAccessSignature.parse(value);
        const config = {
            host: sas.sr,
